...
export const Resume = () => {
  return (
    <section id='curriculum'>
      ...
      <div className='ml-2 flex flex-col gap-16 border-l border-theme-500 pl-7'>
        {[...jobs].reverse().map((job) => (
          <Job {...job} key={uuidv4()} />
        ))}
      </div>
      <h3 className='mb-10 mt-20 text-2xl font-semibold uppercase tracking-widest text-theme-200'>
        Estudios
      </h3>
