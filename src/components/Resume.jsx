...
export const Resume = () => {
    return (
        <section id='curriculum'>
            ...
            <div className='border-theme-500 ml-2 flex flex-col gap-16 border-l pl-7'>
                {[...jobs].reverse().map((job) => (
                    <Job {...job} key={uuidv4()} />
                ))}
            </div>
            <h3 className='text-theme-200 mb-10 mt-20 text-2xl font-semibold uppercase tracking-widest'>
                Estudios
            </h3>
